        ...
        .then(response => {
            ...
            if(total > (offsetValue + numberPostsValue)) { //check the quantity to display the button or not
                ...
                button.addEventListener('click', (e) => {
                    ...
                    responseDiv.firstElementChild.classList.add('cards-container-margin');
                    queryPosts(inputsValues.offset, inputsValues.numberPosts, false);
                });
            }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    items.forEach(item => {
        item.addEventListener('click', e => {
            ...
            let inputsValues = getInputsValues();
            queryPosts(inputsValues.offset, inputsValues.numberPosts, true);
        });
    })
...
// if user clicks anywhere outside the select box, close all select boxes
